...
export default function ListTab({ bookmarks, toggleBookmark, isBookmarked }: Props) {
  ...
  const handleSort = (key: SortKey) => {
    if (sortKey === key) {
      ...
      setSortKey(key);
      // names default to asc (A→Z), numbers default to desc (large→small)
