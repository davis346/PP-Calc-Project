...
export default function CalcTab({ history, setHistory, bookmarks, toggleBookmark, isBookmarked }: Props) {
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={{ paddingBottom: 40 }}>
      {/* Fare mode toggle (domestic only) */}
      {domestic && (
        <View style={s.card}>
      ...
      <View style={s.card}>
        ...
        <View style={s.inputWrap}>
          <TextInput style={s.input} value={price} onChangeText={t => { setPrice(t); setResult(null); }}
            placeholder="例: 25300" keyboardType="numeric" placeholderTextColor="#A0AAB4" />
